...
class PagseguroTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(Pagseguro::class, $this->object);
    }
    ...
    public function testIfSetSender()
    {
        ...
        $this->assertInstanceOf(Pagseguro::class, $this->object->setPayer($payer->reveal()));
    }
    ...
    public function testIfAddProduct()
    {
        ...
        $this->assertInstanceOf(Pagseguro::class, $this->object->addProduct($product1->reveal()));
        $this->assertInstanceOf(Pagseguro::class, $this->object->addProduct($product2->reveal()));
    }
